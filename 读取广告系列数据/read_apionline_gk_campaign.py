...
@Read: 读取广告系列相关数据；读取的是优化从产品出发，投放出来的广告系列数据；
"""
import pickle
import pymysql
import pandas as pd
...
if __name__ == '__main__':
    sql_campaign = """select * from gk_campaign"""
...
CREATE TABLE `gk_campaign` (
  ...
  `bid_amount` decimal(19,2) DEFAULT NULL COMMENT '竞价金额',
  `bid_strategy` varchar(50) DEFAULT NULL COMMENT '竞价策略',
  `budget_type` varchar(50) DEFAULT NULL COMMENT '预算类型',
  ...
  `daily_budget` decimal(19,2) DEFAULT NULL COMMENT '日预算',
